...
from boilerplate_ms_python.config.grpc_interceptor import AuthInterceptor, LoggerInterceptor
...
from boilerplate_ms_python.proto_generated import helloworld_pb2, helloworld_pb2_grpc
